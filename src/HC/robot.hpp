...
namespace w {
  namespace robot {
    ...
    public:
      ...
      void moveAlong(::w::odom::Point wayPoints[], ::w::odom::Point last, int len, float lookAhead, ::w::pid::PIDConfig tPID, ::w::pid::PIDConfig rPID, float err = P_ERR, float exit = 10000);
